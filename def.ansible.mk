...
ANSIBLE_AWS_DOCKER_REGISTRY     ?= $(AWS_DOCKER_REGISTRY)
...
ENV_SYSTEM_VARS                 += ANSIBLE_AWS_ACCESS_KEY_ID ANSIBLE_AWS_DEFAULT_OUTPUT ANSIBLE_AWS_DEFAULT_REGION ANSIBLE_AWS_DOCKER_REGISTRY ANSIBLE_AWS_SECRET_ACCESS_KEY ANSIBLE_EXTRA_VARS ANSIBLE_CONFIG ANSIBLE_GIT_DIRECTORY ANSIBLE_GIT_KEY_FILE ANSIBLE_GIT_REMOTE ANSIBLE_GIT_REPOSITORY ANSIBLE_GIT_VERSION ANSIBLE_INVENTORY ANSIBLE_PLAYBOOK ANSIBLE_SSH_PRIVATE_KEY ANSIBLE_USERNAME ANSIBLE_VERBOSE
