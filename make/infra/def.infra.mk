...
ENV_VARS                        += COMPOSE_IGNORE_ORPHANS DOCKER_IMAGE_CLI DOCKER_IMAGE_SSH DOCKER_NAME_CLI DOCKER_NAME_SSH ELASTICSEARCH_HOST ELASTICSEARCH_PORT GIT_AUTHOR_EMAIL GIT_AUTHOR_NAME SETUP_SYSCTL_CONFIG
...
SHELL                           ?= /bin/sh
STACK                           ?= logs $(if $(filter $(ENV),prod preprod),newrelic,services)
STACK_BASE                      ?= base
STACK_NODE                      ?= node
