...
node-%: bootstrap
	DOCKER_NETWORK=node COMPOSE_IGNORE_ORPHANS=$(COMPOSE_IGNORE_ORPHANS) COMPOSE_PROJECT_NAME=node_infra COMPOSE_SERVICE_NAME=node-infra $(MAKE) docker-$* STACK="$(STACK_NODE)" DOCKER_NETWORK=node COMPOSE_PROJECT_NAME=node_infra COMPOSE_SERVICE_NAME=node-infra ARGS=$(ARGS)
